...
def test_minimum_csv_processed_correctly():
    ...
    data = processor.create_config_from_csv('../tests/tests_python/test_configurations/csv_example_1/example_1.csv')
    expected_data = {
        "groups": [
            {
                "name": "default",
...
def test_maximal_csv_processed_correctly():
    ...
    """
    processor = CsvProcessor()
    data = processor.create_config_from_csv('../tests/tests_python/test_configurations/csv_example_2/example_2.csv')
    expected_data = {
        "groups": [
            {
                "name": "england",

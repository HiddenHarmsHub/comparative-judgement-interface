...
def test_setup_works_for_directory_with_csv():
    ...
    WS.set_configuration_location(app, "../tests/tests_python/test_configurations/csv_example_1")
...
def test_setup_fails_for_directory_with_wrong_files():
    ...
    # 1. Validate the website configuration
    app.logger.info("Setting website configuration")
    WS.set_configuration_location(app, "../tests/tests_python/test_configurations")
...
def test_check_config_path_correct(equal_weight_app):
    ...
    """
    validator = Validation(equal_weight_app)
    validator.check_config_path("../tests/tests_python/test_configurations/csv_example_1")
...
def test_check_config_path_incorrect_directory(equal_weight_app):
    ...
    validator = Validation(equal_weight_app)
    with pytest.raises(SystemExit):
        validator.check_config_path("../tests/tests_python/test_configurations")
...
def test_check_config_path_incorrect_file(equal_weight_app):
    ...
    validator = Validation(equal_weight_app)
    with pytest.raises(SystemExit):
        validator.check_config_path("../tests/tests_python/test_configurations/csv_example_1/example_1.csv")

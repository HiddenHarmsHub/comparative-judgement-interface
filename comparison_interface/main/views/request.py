...
class Request:
    ...
    def get_layout_text(self):
        ...
        return {
            ...
            'participant_registration_page_title': WS.get_text(
                WS.PAGE_TITLE_USER_REGISTRATION, self._language, self._app
            ),
            ...
            'site_cookies_accept_button_label': WS.get_text(
                WS.SITE_COOKIES_ACCEPT_BUTTON_LABEL, self._language, self._app
            ),
